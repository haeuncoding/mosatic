export default class SAnimate {
    constructor () {
        this.mainObj = new Image();
        this.mainObj.src = './src/animations/images/S.png'
    ...
    draw() {
        ...
        this.context.drawImage(this.mainObj, 0, 0, (this.mainObj.width) / 4, (this.mainObj.height) / 4)
